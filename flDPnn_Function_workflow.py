...
for j in range(0,len(CAID_ID),1):
        ...
        fig.add_trace(go.Scatter(x=Position, y=DisorderPrediction_Score_byProteins[j],name='Disorder Score',
        ...
        fig.add_trace(go.Scatter(x=Disordered_Residues, y=Y_Disorder,mode='markers',name='Disordered Regions',
        ...
        fig.add_trace(go.Scatter(x=Disordered_Residues, y=Y_Protein,mode='markers',name='Protein Binding Regions',
            marker=dict(
                size=16,
        ...
        fig.add_trace(go.Scatter(x=Disordered_Residues, y=Y_DNA,mode='markers',name='DNA Binding Regions',
            marker=dict(
                size=16,
        ...
        fig.add_trace(go.Scatter(x=Disordered_Residues, y=Y_RNA,mode='markers',name='RNA Binding Regions',
            marker=dict(
                size=16,
        ...
        fig.add_trace(go.Scatter(x=Disordered_Residues, y=Y_Linker,mode='markers',name='Linker Regions',opacity=1,
            marker=dict(
                size=16,
        ...
        fig.update_layout( {'height':600, 
                            ...
                            'yaxis':{'range': [0, 1], 'dtick': 0.2,'mirror':True,'title':'fldpnn diorder propensity'},
        ...
        fig.write_html(output_dir+"/"+str(CAID_ID[j])+'.html')
        fig.show()
